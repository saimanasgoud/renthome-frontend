...
export default function NearMe() {
  ...
  <div className="flex flex-col items-center justify-center mt-10 gap-4">
    ...
    {/* Spinner */}
    <div className="w-10 h-10 mt-10 border-4 border-violet-200 border-t-blue-600 rounded-full animate-spin"></div>

    {/* Vibrating line */}

    <p className="text-gray-600">Almost there, getting things ready...</p>
  </div>
)}

      {/* CONTENT BELOW BUTTONS */}
      {!loadingHomes && activePanel === "permission" && permissionPanel}
{!loadingHomes && activePanel === "manual" && manualPanel}
      {/* 🔥 BEST RESULTS PANEL */}

{!loadingHomes && activePanel === "results" && (
          <div className="mt-8">
